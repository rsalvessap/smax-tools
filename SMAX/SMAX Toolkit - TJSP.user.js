...
(() => {
  ...
  const SMAX_TOOLKIT_VERSION = '1.68';
  ...
  const ResponseHUD = (() => {
    ...
    const fetchTickets = async () => {
      ...
      const layout = 'Id,Status,PhaseId,CreateTime,ExpertAssignee,RequestedForPerson,StatusSCCDSMAX_c,AssignedToGroup,GlobalId_c.item';
      ...
      try {
        ...
        allFetchedEntries = entities.map(e => {
          ...
          // Ingere no triageCache (inclusive globalChangeId via GlobalId_c)
